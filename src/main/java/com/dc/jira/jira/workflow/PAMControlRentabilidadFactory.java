...
public class PAMControlRentabilidadFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginValidatorFactory {
	 ...
	 */
	public PAMControlRentabilidadFactory(CustomFieldManager customFieldManager) {
