...
public class CECCompletarDatosPhoenixFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory {
	...
	public CECCompletarDatosPhoenixFactory(ProjectManager projectManager, IssueManager issueManager, ProjectRoleManager projectRoleManager,
	...
	protected void getVelocityParamsForInput(Map<String, Object> velocityParams) {
		...
		// Para obtener los usuarios administradores de JIRA independientes del proyecto en el que estemos
