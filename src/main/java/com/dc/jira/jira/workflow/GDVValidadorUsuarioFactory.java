...
public class GDVValidadorUsuarioFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginValidatorFactory {
	 ...
	 */
	public GDVValidadorUsuarioFactory(CustomFieldManager customFieldManager) {
