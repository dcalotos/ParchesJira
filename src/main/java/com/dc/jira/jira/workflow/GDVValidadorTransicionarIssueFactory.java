...
public class GDVValidadorTransicionarIssueFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginValidatorFactory {
	 ...
	 */
	public GDVValidadorTransicionarIssueFactory(CustomFieldManager customFieldManager) {
