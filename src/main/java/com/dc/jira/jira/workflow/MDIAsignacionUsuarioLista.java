...
public class MDIAsignacionUsuarioLista extends AbstractJiraFunctionProvider{
    private static final Logger log = LoggerFactory.getLogger(MDIAsignacionUsuarioLista.class);
