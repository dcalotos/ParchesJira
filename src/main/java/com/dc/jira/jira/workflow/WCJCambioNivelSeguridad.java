...
public class WCJCambioNivelSeguridad extends AbstractJiraFunctionProvider {
	private static final Logger log = LoggerFactory.getLogger(WCJCambioNivelSeguridad.class);
