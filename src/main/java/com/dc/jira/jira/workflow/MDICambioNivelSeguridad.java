...
public class MDICambioNivelSeguridad extends AbstractJiraFunctionProvider {
	private static final Logger log = LoggerFactory.getLogger(MDICambioNivelSeguridad.class);
	...
	public void execute(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
		...
		while (it.hasNext()) {
			...
			log.warn("issueSecurityLevel.getName(): " + issueSecurityLevel.getName());
			if (issueSecurityLevel.getName().contains("Mantenimiento de Instalaciones")) {
		...
		issueManager.updateIssue(UserUtils.getUser((String) args.get("adminUser")), issue,
