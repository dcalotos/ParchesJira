...
public class TPAsignacionResponsableCreacionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory{
	...
	public TPAsignacionResponsableCreacionFactory(ProjectManager projectManager, IssueManager issueManager, ProjectRoleManager projectRoleManager,
	...
	protected void getVelocityParamsForInput(Map<String, Object> velocityParams) {
		...
		Project project = projectManager.getProjectObjByKey("TP");
