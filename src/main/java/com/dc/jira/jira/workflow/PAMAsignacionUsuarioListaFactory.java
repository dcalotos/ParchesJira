...
public class PAMAsignacionUsuarioListaFactory extends AbstractWorkflowPluginFactory  implements WorkflowPluginFunctionFactory{
	...
	public PAMAsignacionUsuarioListaFactory(ProjectManager projectManager, IssueManager issueManager, ProjectRoleManager projectRoleManager,
	...
	protected void getVelocityParamsForInput(Map<String, Object> velocityParams) {
		...
		Project project = projectManager.getProjectObjByKey("PAM");
