...
public class CECAsignacionEspecialistaFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory{
	public static final String USER_ADMIN = "userAdmin";

	private ProjectManager projectManager;
	private ProjectRoleManager projectRoleManager;

	public CECAsignacionEspecialistaFactory(ProjectManager projectManager, IssueManager issueManager, ProjectRoleManager projectRoleManager,
